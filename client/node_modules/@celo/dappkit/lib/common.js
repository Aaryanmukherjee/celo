...
exports.requestTxSigFactory = exports.FeeCurrency = exports.requestAccountAddressFactory = exports.checkSignedTxs = exports.checkAccountAuth = exports.VALORA_APP_URL = exports.ANDROID_STORE_URL = exports.IOS_STORE_URL = exports.SignTxRequest = exports.serializeDappKitRequestDeeplink = exports.AccountAuthRequest = void 0;
...
exports.IOS_STORE_URL = 'https://apps.apple.com/de/app/valora-celo-payments-app/id1520414263';
exports.ANDROID_STORE_URL = 'https://play.google.com/store/apps/details?id=co.clabs.valora';
exports.VALORA_APP_URL = 'https://valoraapp.com/';
function checkAccountAuth(requestId, dappKitResponse) {
    return (requestId === dappKitResponse.requestId &&
...
exports.checkAccountAuth = checkAccountAuth;
function checkSignedTxs(requestId, dappKitResponse) {
    return (requestId === dappKitResponse.requestId &&
        dappKitResponse.type === utils_1.DappKitRequestTypes.SIGN_TX &&
        dappKitResponse.status === utils_1.DappKitResponseStatus.SUCCESS);
}
exports.checkSignedTxs = checkSignedTxs;
function requestAccountAddressFactory(meta, openURLCallback) {
    openURLCallback((0, utils_1.serializeDappKitRequestDeeplink)((0, utils_1.AccountAuthRequest)(meta)));
}
exports.requestAccountAddressFactory = requestAccountAddressFactory;
var FeeCurrency;
...
function requestTxSigFactory(kit, txParams, meta, openURLCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var baseNonce, txs, request;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, kit.connection.nonce(txParams[0].from)];
                case 1:
                    baseNonce = _a.sent();
                ...
                case 2:
                    txs = _a.sent();
                    request = (0, utils_1.SignTxRequest)(txs, meta);
                    openURLCallback((0, utils_1.serializeDappKitRequestDeeplink)(request));
                    return [2 /*return*/];
            }
        });
    });
}
exports.requestTxSigFactory = requestTxSigFactory;
